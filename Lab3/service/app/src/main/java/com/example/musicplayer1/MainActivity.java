...
public class MainActivity extends AppCompatActivity implements MusicPlayerServices.MusicControlCallback {
    ...
    private ServiceConnection conn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            control.setCallback(MainActivity.this);
        }
    ...
    public void onMusicStarted() {
        // 处理音乐开始播放的逻辑，例如更新界面或者显示通知等
        Toast.makeText(this, "音乐已开始播放", Toast.LENGTH_SHORT).show();
    }
    @Override
    ...
    public void onMusicResumed() {
        // 处理音乐继续播放的逻辑
        Toast.makeText(this, "音乐已继续播放", Toast.LENGTH_SHORT).show();
    }
    @Override
    public void onMusicStopped() {
        // 处理音乐停止播放的逻辑
        Toast.makeText(this, "音乐已退出播放", Toast.LENGTH_SHORT).show();
    }
    @Override
    ...
    class OnClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (viewId == R.id.btn_play) {
                ...
                animator.resume();
                // 将服务设置为后台服务
                control.setAsBackgroundService(true);
