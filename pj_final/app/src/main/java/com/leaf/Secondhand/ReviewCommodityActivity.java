...
import com.leaf.Secondhand.adapter.ReviewAdapter;
import com.leaf.Secondhand.bean.Collection;
import com.leaf.Secondhand.bean.Review;
import com.leaf.Secondhand.util.MyCollectionDbHelper;
import com.leaf.Secondhand.util.ReviewDbHelper;
...
public class ReviewCommodityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (b != null) {
            ...
            Bitmap img = BitmapFactory.decodeByteArray(picture, 0, picture.length, options);
