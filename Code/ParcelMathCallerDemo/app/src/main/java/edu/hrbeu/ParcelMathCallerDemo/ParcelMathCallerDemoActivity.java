	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bindButton.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View v) {
				if(!isBound){
					final Intent serviceIntent = new Intent(ParcelMathCallerDemoActivity.this,edu.hrbeu.ParcelMathServiceDemo.MathService.class);
					/*serviceIntent.setPackage("edu.hrbeu.ParcelMathCallerDemo");
